...
function getFirstWord1(a) {
    return a.split(/ +/)[0].length;
}
// 2. 
function getUserNamings1(a) {
    return {
...
function getAllProductNames1(a) {
    var _a;
...
const hello1 = () => __awaiter(void 0, void 0, void 0, function* () {
    return yield world1(10);
});
